...
CSV_COLUMNS: tuple[str, ...] = (
    ...
    "wheelsPressure_rl",
    "wheelsPressure_rr",
    # Tier-1 base-AC dynamic channels (issue #490) — blank for archives that lack them. Identity CSV
    # names; kept in sync with reference_lap.TRACE_FIELDS[30:] (see test_lap_archive_export).
    "tyreTempInner_fl",
    "tyreTempInner_fr",
    "tyreTempInner_rl",
    "tyreTempInner_rr",
...
# Tier-1 base-AC dynamic channels (issue #490); blank for archives that lack them. MUST stay in
# sync with reference_lap.TRACE_FIELDS[30:] — asserted by test_lap_archive_export.
_TIER1_DYNAMIC_TRACE_FIELDS: tuple[str, ...] = (
    "tyreTempInner_fl",
    "tyreTempInner_fr",
    "tyreTempInner_rl",
    "tyreTempInner_rr",
