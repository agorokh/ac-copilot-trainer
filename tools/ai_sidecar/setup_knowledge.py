...
PARAM_EFFECTS: dict[str, ParamEffect] = {
    "FRONT_BIAS": ParamEffect(
        ...
        ("front lock", "rear lock", "entry rotation under braking"),
        "high",
    ),
    "ABS": ParamEffect(
        "ABS",
        ...
        ("braking distance ceiling", "lockup safety net"),
        "medium",
    ),
    "BRAKE_POWER_MULT": ParamEffect(
        ...
        ("pedal sensitivity", "lockup tendency"),
        "medium",
    ),
    "PRESSURE": ParamEffect(
        ...
        ("mechanical grip", "tyre thermal centre-vs-shoulder", "lockup tendency"),
        "high",
    ),
    "TYRES": ParamEffect(
        "TYRES",
        ...
        ("qual-vs-race grip/consistency", "temp window match"),
        "medium",
        car_dependent=True,
    ),
    "CAMBER": ParamEffect(
        ...
        "load.",
        ("mid-corner grip", "braking grip", "edge-temp balance"),
        "high",
    ),
    "TOE_OUT": ParamEffect(
        "TOE_OUT",
        ...
        ("turn-in response", "straight-line stability", "scrub heat/wear"),
        "high",
    ),
    "WING_1": ParamEffect(
        "WING_1",
        ...
        ("high-speed front grip / aero balance",),
        "high",
        car_dependent=True,
    ),
    "WING_2": ParamEffect(
        ...
        ("high-speed rear stability / aero balance", "top speed"),
        "high",
    ),
    "ARB_FRONT": ParamEffect(
        ...
        ("all-speed mechanical front balance", "understeer"),
        "high",
    ),
    "ARB_REAR": ParamEffect(
        ...
        ("all-speed mechanical rear balance", "entry rotation", "exit traction"),
        "high",
    ),
    "ROD_LENGTH": ParamEffect(
        ...
        ("speed-dependent aero balance (rake)", "CG / mechanical balance"),
        "medium",
        car_dependent=True,
    ),
    "SPRING_RATE": ParamEffect(
        ...
        ("mechanical balance", "aero platform / dynamic ride height"),
        "medium",
    ),
    "TRACTION_CONTROL": ParamEffect(
        ...
        "wheelspin/snap risk.",
        ("exit wheelspin safety net vs exit acceleration",),
        "high",
    ),
    "DIFF_POWER": ParamEffect(
        ...
        ("exit power-on balance", "exit traction vs rotation"),
        "high",
    ),
    "DIFF_COAST": ParamEffect(
        ...
        ("entry/mid off-throttle balance", "lift-off stability vs rotation"),
        "high",
    ),
    "FINAL_RATIO": ParamEffect(
        ...
        ("acceleration vs top speed", "torque-spike wheelspin"),
        "high",
    ),
}
