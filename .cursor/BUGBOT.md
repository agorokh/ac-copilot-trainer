...
- Follow **AGENTS.md**, **AGENT_CORE_PRINCIPLES.md**, **`docs/00_Core/SESSION_LIFECYCLE.md`**, and vault **invariants** (`docs/01_Vault/<ProjectKey>/00_System/invariants/_index.md`).
