...
Routing tables, agent roles, skills map, and delegation patterns live in **`.claude/rules/orchestration.md`** (loaded when working under `.claude/agents/` or agent docs). The canonical matrix remains **`.claude/skills/orchestrate/SKILL.md`**.
