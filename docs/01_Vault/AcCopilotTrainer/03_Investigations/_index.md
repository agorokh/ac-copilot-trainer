...
| [issue-188-wrap-skew-rig-verification.md](issue-188-wrap-skew-rig-verification.md) | #188 empirical gate: `resetCounter` presence + s/f wrap-skew frame logging on the rig. Code (#199) on `main`; macOS agent blocked on SSH; runbook for ≥2-lap grep on `pc`. |
