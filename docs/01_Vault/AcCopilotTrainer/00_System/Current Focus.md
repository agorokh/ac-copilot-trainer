...
Final code commit `af2a47e` adds finite timing enforcement at the shared rig-lock boundary,
...
sentinel for unknown or legacy metadata. Required checks are green, all 25 review threads are
