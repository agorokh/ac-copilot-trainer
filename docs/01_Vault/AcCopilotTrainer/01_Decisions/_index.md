...
- [cold-side-temperature-tagged-friction-refit-2026-08-28](cold-side-temperature-tagged-friction-refit-2026-08-28.md) — admit below-optimum track-load cycles through four-wheel row attribution and a globally coldest 5 C runtime projection (issue #749).
